...
sample function has order at most two and, if its order is two, type at most
one.
...
The author thanks Xi Chen for reading an earlier version and for detailed
suggestions that improved the introduction, theorem formulation and
circle-average estimate.
