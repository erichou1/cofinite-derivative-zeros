...
During the preparation of this work the author used AI tools --- GPT-5.6 Sol,
which assisted with the proof of the small-ball estimate and with editing the
manuscript, and Anthropic's Claude models (Fable and Opus), which assisted
with revising the manuscript and auditing the argument --- and the author has
verified the argument and takes sole responsibility for the mathematical
