...
\]
The perpendicular choice above exhibits strict inequality at the two angles
$\theta_0$ and $\theta_0+\pi$. Those points have measure zero. Since
$\varphi$ is continuous and $\varphi(\theta_0)>0$, there is a
$\delta>0$ such that
